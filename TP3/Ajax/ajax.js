...
ajaxRequest("GET","http://localhost/ComWeb/TP3/Ajax/timestamp.php",modifyHTML);
var interval = setInterval(ajaxRequest,1000,"GET","http://localhost/ComWeb/TP3/Ajax/timestamp.php",modifyHTML);
